...
from .siglip_encoder_cl import ContinualSigLipVisionTower
...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    elif "continual_siglip" in vision_tower:
        return ContinualSigLipVisionTower(vision_tower, vision_tower_cfg=vision_tower_cfg, **kwargs)
