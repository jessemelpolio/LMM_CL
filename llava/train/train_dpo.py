    ...
    if model_args.vision_tower is not None:
        ...
        if data_args.image_grid_pinpoints is not None:
            ...
            if "x" in data_args.image_grid_pinpoints and "..." in data_args.image_grid_pinpoints:
                ...
                vis_encoder_size = get_processor_shortest_edge(data_args.image_processor)
                ...
                from llava.mm_utils import get_processor_shortest_edge
                vis_encoder_size = get_processor_shortest_edge(data_args.image_processor)
                if vis_encoder_size not in [224, 336, 384, 448, 512]:
                    from llava.utils import rank0_print
                    rank0_print(f"Warning: unexpected processor size {vis_encoder_size}; proceeding anyway.")
