...
EXPERIMENT_NAME="tune_parts_mlp"
LR=5e-6
...
# Example: export IMAGE_FOLDER=/path/to/your/image/data
...
for task_index in "${!TASKS[@]}"; do
    ...
    # if [ "$task_index" -lt 4 ]; then
    #     echo "Skipping training for task ${TASK} (${task_index})"
    # else
    ...
    #     echo "Skipping evaluation for final task ${TASK} (${task_index})"
    # else
