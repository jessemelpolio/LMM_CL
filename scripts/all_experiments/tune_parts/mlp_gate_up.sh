...
# CUDA and system environment setup (ARM architecture)
...
# Unset BNB_CUDA_VERSION as it's not needed for this configuration
...
EXPERIMENT_NAME="tune_parts_mlp_gate_up"
LR=5e-6
