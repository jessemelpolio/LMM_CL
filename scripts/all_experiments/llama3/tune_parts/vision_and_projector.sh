...
# Environment (ARM-friendly defaults; mirror tune_parts/sa_proj_and_mlp_gate_up.sh)
...
EXPERIMENT_NAME="llama3_tune_parts_vision_and_projector"
LR=${LR:-5e-6}
VISION_TOWER_LR=${VISION_TOWER_LR:-2e-6}

############### Model config ################
# From llama3/sa_proj.sh
...
# Benchmarks (match tune_parts/sa_proj_and_mlp_gate_up.sh)
