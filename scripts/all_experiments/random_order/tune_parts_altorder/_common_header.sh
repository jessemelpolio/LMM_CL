...
# Environment (ARM-friendly defaults; mirrors latest llama3 scripts)
...
# Toolchain (match system compilers)
export CC=${CC:-/usr/bin/gcc-13}
export CXX=${CXX:-/usr/bin/g++-13}

# Optional CUDA path (uncomment or override in your job env)
# export CUDA_HOME=/opt/nvidia/hpc_sdk/Linux_aarch64/24.3/cuda/12.3
...
TASKS=("pathvqa" "cub200" "textvqa" "timeclock" "pixmocount")
